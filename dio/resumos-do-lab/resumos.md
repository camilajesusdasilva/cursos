...
|             Aulas             |
|-------------------------------|
|  [Introdução ao Ambiente Cloud](https://github.com/camilajesusdasilva/cursos/edit/main/dio/resumos-do-lab/resumos.md#introdu%C3%A7%C3%A3o-ao-ambiente-cloud) |
|  [Conceitos Iniciais de Cloud com Azure](https://github.com/camilajesusdasilva/cursos/edit/main/dio/resumos-do-lab/resumos.md#introdu%C3%A7%C3%A3o-ao-ambiente-cloud) |
...
A nuvem tem como objetivo ajudar n

- Alta disponibilidade: direito que a Microsoft dá quando algum evento ou 
interrupção atrapalha o uso do produto.
- Escalabilidade: é a capacidade de ajustar os recursos para atender a demanda, como a
compra de espaço em uma aplicação que serve para guardar arquivos.
- Elasticidade: 
